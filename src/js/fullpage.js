...
(function (global, fn) {
  ...
  /**
   * 扩展 Option 对象
   * @param Default {Object} 默认设置
   * @param Customize {Object} 自定义设置
   * @returns Default {Object} 扩展后的设置
   */
  ...
  /**
   * 页面滚动主要逻辑
   * @type {{nowPage: number, isScrolling: boolean, scrollPage: page.scrollPage, scrollSlide: page.scrollSlide, moveTo: page.moveTo, move: {next: page.move.next, pre: page.move.pre}, slide: {move: page.slide.move, next: page.slide.next, pre: page.slide.pre}}}
   */
  var page = {
    nowPage: 1,
    isScrolling: false,
     ...
     * @param {number} pageIndex The page index you want scroll to.
     * @returns {boolean}
     */
     ...
     * @param {number} slideIndex The slide index you want scroll to.
     * @returns {boolean}
     */
     ...
     * 切换到指定的 section 和 slide
     * @param {number} pageIndex 要移动到 section 的 index
     * @param {number} slideIndex 要移动到 slide 的 index
     * @returns {boolean}
     */
    ...
    slide: {
      ...
      move: function (direction) {
        var slideWrap = $$('.fp-slide-wrap', sections[page.nowPage - 1])[0];
        var slide = sections[page.nowPage - 1].querySelectorAll('.fp-slide');
        //TODO 添加 slideNowIndexChange 和 slideWillBe 的说明
        // slideNowIndexChange slideNowIndex 将要的变化
        var slideNowIndexChange;

...
const stepHeight = $$('body')[0].scrollHeight;
const stepWidth = $$('body')[0].scrollWidth;
...
let page = {
  ...
  scrollPage: function (pageIndex) {
    ...
    let controllers = $$('.fp-controller-dotted');
  ...
  scrollSlide: function (slideIndex) {
    ...
    //获取slide包裹层
    let slideWrap = $$('.fp-slide-wrap', sections[page.nowPage - 1])[0];
